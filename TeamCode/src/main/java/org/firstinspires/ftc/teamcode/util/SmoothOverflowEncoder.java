...
public final class SmoothOverflowEncoder implements Encoder {
	...
	private final RollingAvg avgEstimate;

	public SmoothOverflowEncoder(RawEncoder e) {
		encoder = e;
